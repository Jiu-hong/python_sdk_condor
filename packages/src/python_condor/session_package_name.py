...
def serialize_package_name(package_name, version, entrypoint, runtime_args):
    StoredPackageByNameTag = '04'
    ...
    result = StoredPackageByNameTag + serialize_string(package_name).hex() + \
        version_bytes.hex() + \
